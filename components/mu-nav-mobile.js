		...
		<div class="w-4/5 h-full bg-gray-800 shadow-lg overflow-x-hidden overflow-y-auto pb-16">
			...
			<ul class="pl-0">
				<li class="block w-full font-semibold" x-data="{ open: false }">
					...
					<div class="bg-gray-900 w-full py-4 px-4 text-white font-normal flex flex-col" x-show="open" style="display: none;">
						...
						<div class="mt-5">
							...
							<div class="block mt-1">
								<a href="http://www.marshall.edu/marsha/" class="text-white text-sm">Web Guidelines</a>
							</div>
							<div class="block mt-1">
				...
				<li class="block w-full font-semibold" x-data="{ open: false }">
					...
					<div class="bg-gray-900 w-full py-4 px-4 text-white font-normal flex flex-col" x-show="open" style="display: none;">
						<div class="">
							...
							<div class="block flex-1 text-center text-white tracking-wide h-1 mb-2 bg-repeat-x" style="background-image: url('https://www.marshall.edu/wp-content/themes/marsha/images/grey-lighter-dot.svg')"></div>
							<div class="block mt-1">
								<a href="https://www.marshall.edu/admissions/undergraduate/freshmen/" class="text-white text-sm">First-Year Freshmen</a>
							</div>
							<div class="block mt-1">
								<a href="https://www.marshall.edu/admissions/undergraduate/transfer/" class="text-white text-sm">Transfer Students</a>
							</div>
							<div class="block mt-1">
								<a href="http://www.marshall.edu/admissions/international-undergraduate/" class="text-white text-sm">International Undergraduate Students</a>
							</div>
							<div class="block mt-1">
								<a href="http://www.marshall.edu/graduate/" class="text-white text-sm">Graduate Students</a>
							</div>
							<div class="block mt-1">
								<a href="http://www.marshall.edu/admissions/international-graduate/" class="text-white text-sm">International Graduate Students</a>
							</div>
							<div class="block mt-1">
						...
						<div class="mt-5">
							...
							<div class="block flex-1 text-center text-white tracking-wide h-1 mb-2 bg-repeat-x" style="background-image: url('https://www.marshall.edu/wp-content/themes/marsha/images/grey-lighter-dot.svg')"></div>
							<div class="block mt-1">
								<a href="https://www.marshall.edu/experience/" class="text-white text-sm">Experience Marshall</a>
							</div>
							<div class="block mt-1">
							...
							<!-- <div class="block mt-1">
								<a href="https://www.marshall.edu/newstudentchecklist/submit-enrollment-deposit/" class="text-white text-sm">Pay Enrollment Deposit</a>
							</div> -->
							<!-- <div class="block mt-1">
									<a href="#" class="text-white text-sm">Next Steps</a>
								</div> -->
						</div>
						<div class="mt-5">
				...
				<li class="w-full border-b border-gray-900 py-4 px-4 font-semibold">
					<a href="http://www.herdzone.com" class="text-white flex items-center uppercase">Athletics</a>
				</li>
			</ul>
