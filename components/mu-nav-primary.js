	...
	render() {
		return html`
			...
			<div id="primary-mobile-navigation">
				<div class="relative">
	<div class="flex z-90 w-full h-full fixed top-0 left-0 mobile-nav lg:hidden off-canvas" :class="{ 'active' : mobileMenuOpen }">
		<div class="w-1/5">
		...
		<div class="w-4/5 h-full bg-gray-800 shadow-lg overflow-x-hidden overflow-y-auto pb-16">
			...
			<div>
				<div class="block w-full font-semibold" x-data="{ open: false }">
					<div x-on:click.prevent="open = !open" class="text-white flex items-center justify-between px-4 border-b border-gray-900 py-4 no-underline hover:text-green-bright active:text-green-bright cursor-pointer">
